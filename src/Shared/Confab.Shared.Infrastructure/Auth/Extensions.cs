...
{
    public static IServiceCollection AddAuth(this IServiceCollection services, IEnumerable<IModule>? modules = null,
        Action<JwtBearerOptions>? optionsFactory = null)
    {
        ...
        //    foreach (var policy in policies)
        //    {
        //        a.AddPolicy(policy, x => x.RequireClaim("permissions", policy));
        //    }
        //});
